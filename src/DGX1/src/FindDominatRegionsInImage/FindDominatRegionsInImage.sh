...
IMAGE_NAME="$SIF_FOLDER/FindDominatRegionsInImage.sif"
DEFINITION_FILE="/home/tobias.rothlin/GeoLocalization/src/DGX1/src/FindDominatRegionsInImage/FindDominatRegionsInImage.def"
TMUX_SESSION="find_dominat_regions_in_image_pipeline"
LOG_FILE="/home/tobias.rothlin/data/Logs/FindDominatRegionsInImage_output_$(date +"%Y-%m-%d_%H-%M-%S").log"
REBUILD=false
USE_TMUX=false
