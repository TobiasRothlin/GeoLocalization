...
IMAGE_NAME="$SIF_FOLDER/ReverseGeocoding.sif"
DEFINITION_FILE="/home/tobias.rothlin/GeoLocalization/src/DGX1/src/ReverseGeocoding/ReverseGeocoding.def"
TMUX_SESSION="reverse_geocoding_pipeline"
LOG_FILE="/home/tobias.rothlin/data/Logs/ReverseGeocoding_output_$(date +"%Y-%m-%d_%H-%M-%S").log"
REBUILD=false
USE_TMUX=false
