...
IMAGE_NAME="$SIF_FOLDER/CreateHoldoutDataset.sif"
DEFINITION_FILE="/home/tobias.rothlin/GeoLocalization/src/DGX1/src/CreateHoldoutDataset/CreateHoldoutDataset.def"
TMUX_SESSION="create_holdout_dataset_pipeline"
LOG_FILE="/home/tobias.rothlin/data/Logs/CreateHoldoutDataset_output_$(date +"%Y-%m-%d_%H-%M-%S").log"
REBUILD=false
USE_TMUX=false
