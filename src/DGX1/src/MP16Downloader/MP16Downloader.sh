...
IMAGE_NAME="$SIF_FOLDER/MP16Downloader.sif"
DEFINITION_FILE="/home/tobias.rothlin/GeoLocalization/src/DGX1/src/MP16Downloader/MP16Downloader.def"
TMUX_SESSION="mp16_dataCollection_pipeline"
REBUILD=false
USE_TMUX=false

LOG_FILE="/home/tobias.rothlin/data/Logs/Mp16Collection_output_$(date +"%Y-%m-%d_%H-%M-%S").log"
