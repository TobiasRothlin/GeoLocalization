...
IMAGE_NAME="$SIF_FOLDER/RegressionPretrainingPipeline.sif"
DEFINITION_FILE="/home/tobias.rothlin/GeoLocalization/src/DGX1/src/RegressionPretraining/RegressionPretraining.def"
TMUX_SESSION="encoder_regression_pretraining_pipeline_session"
