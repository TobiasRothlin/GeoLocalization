...
IMAGE_NAME="$SIF_FOLDER/EncoderFineTuningPipeline.sif"
DEFINITION_FILE="/home/tobias.rothlin/GeoLocalization/src/DGX1/src/EncoderFineTuning/EncoderFineTuning.def"
TMUX_SESSION="encoder_training_pipeline_session"
