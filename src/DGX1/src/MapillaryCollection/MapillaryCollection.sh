...
IMAGE_NAME="$SIF_FOLDER/MapillaryCollection.sif"
DEFINITION_FILE="/home/tobias.rothlin/GeoLocalization/src/DGX1/src/MapillaryCollection/MapillaryCollection.def"
TMUX_SESSION="mapillary_dataCollection_pipeline"
REBUILD=false
USE_TMUX=false

LOG_FILE="/home/tobias.rothlin/data/Logs/MapillaryCollection_output_$(date +"%Y-%m-%d_%H-%M-%S").log"
