...
IMAGE_NAME="$SIF_FOLDER/FileValidation.sif"
DEFINITION_FILE="/home/tobias.rothlin/GeoLocalization/src/DGX1/src/FileValidation/FileValidation.def"
TMUX_SESSION="file_validation_pipeline"
LOG_FILE="/home/tobias.rothlin/data/Logs/Validation_output_$(date +"%Y-%m-%d_%H-%M-%S").log"
REBUILD=false
USE_TMUX=false
