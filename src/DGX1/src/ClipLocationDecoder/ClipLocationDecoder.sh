...
IMAGE_NAME="$SIF_FOLDER/ClipLocationDecoder.sif"
DEFINITION_FILE="/home/tobias.rothlin/GeoLocalization/src/DGX1/src/ClipLocationDecoder/ClipLocationDecoder.def"
TMUX_SESSION="clip_decoder_training_pipeline_session"
