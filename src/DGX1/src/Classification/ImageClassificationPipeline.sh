...
IMAGE_NAME="$SIF_FOLDER/ImageClassificationPipeline.sif"
DEFINITION_FILE="/home/tobias.rothlin/GeoLocalization/src/DGX1/src/Classification/ImageClassificationPipeline.def"
TMUX_SESSION="image_classification_pipeline_session"
LOG_FILE="/home/tobias.rothlin/data/Logs/Classification_output_$(date +"%Y-%m-%d_%H-%M-%S").log"
